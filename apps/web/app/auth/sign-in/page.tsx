      ...
      <main className={styles.authMain}>
        ...
        <div className={styles.authFormSide}>
          <div className={styles.authFormContainer}>
            <h1 className={styles.authTitle}>Se connecter</h1>

            <form onSubmit={handlePasswordSignIn} className={styles.authForm}>
              <div className={styles.authField}>
                <label htmlFor="signin-email" className={styles.authLabel}>
              ...
              <div className={styles.authField}>
                <label htmlFor="signin-password" className={styles.authLabel}>
                  Mot de passe
                </label>
                <input
                  id="signin-password"
              ...
              <div className={styles.authForgot}>
                <span>Vous ne pouvez pas vous connecter ?</span>{' '}
                <Link href="/auth/reset-password" className={styles.authLink}>
